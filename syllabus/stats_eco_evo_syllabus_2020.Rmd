...
Students who do not have access to a personal computer or who are unable to install the required software and packages can take advantage of [Codio](https://www.codio.com/), which provides access to R and RStudio on any computer with internet access. This provides a flexible means of completing the course assignments on a machine of your choosing (i.e., lab, library, or personal computer). Further instruction on use of Codio will be given during lab sections for students wanting to exercise this option.
